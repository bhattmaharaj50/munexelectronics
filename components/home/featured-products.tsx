  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 lg:px-8">
      ...
      >
        <div>
          <span className="inline-flex items-center gap-2 rounded-full border border-[#E5E5E5] bg-[#F5F5F7] px-3.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-[#6E6E73]">
            <Sparkles className="h-3 w-3" /> Hand-picked
          </span>
      ...
      <div className="mt-10 flex justify-center md:hidden">
        <Link href="/products" className="inline-flex items-center gap-2 rounded-full border border-[#E5E5E5] bg-white px-6 py-3 text-sm font-semibold text-[#111111] shadow-sm transition-all hover:bg-[#F5F5F7]">
